	...
	<c:when test="${data.customer_id > 0}">
		<h3>
			Edit Customer<a
				...
				class="btn btn-small btn-info pull-right" style="margin-top: 15px;">View
				Details of this Customer</a>
		</h3>
	</c:when>
	<c:otherwise>
		<h3>New Customer</h3>
...
<form name="form-customer" id="form-customer"
	action="${page.url_host}${page.url_apppath}admin/post/save_customer"
	method="post">
	<table class="table">
		<tr>
			<td>Customer ID</td>
			<td><input type="text" disabled="disabled" autocomplete="off"
				value="<c:if test="${data.customer_id > 0}">${data.customer_id}</c:if>" />
		...
		<tr>
			<td>NRIC</td>
			<td><input value="${data.nric}" name="nric" type="text" autocomplete="off"
				required="required" placeholder="NIRC" /></td>
		</tr>
		<tr>
			<td>Username</td>
			<td><input value="${data.username}" name="username" type="text" autocomplete="off"
		...
		<tr>
			<td>Address</td>
			<td><textarea name="address" type="textarea" required="required" autocomplete="off"
					placeholder="Address">${data.address}</textarea></td>
		</tr>
		<tr>
			<td>Gender</td>
		...
		<tr>
			<td><a class="btn btn-primary btn-large"
				href="${page.url_host}${page.url_apppath}admin/customer/list">Cancel</a></td>
